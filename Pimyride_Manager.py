...
class MySheet(wx.Panel):
    ...
    def OnOpen(self, event):
        ...
        # Put the colum headings in place
...
class PiMyRide(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        # Set the bozsizer for the buttons accross the bottom
...
class graph(wx.Dialog):
    ...
    def OnLine1(self, child):
        ...
        gc = plot.PlotGraphics(
                               [line], 'Speed Vs Fuel Consumption     Trip Distance: ' + '%.2f' % graph.Trip_Distance, 'Miles Per Hour', 'Fuel Consumption')
    ...
    def OnLine2(self, child):
        ...
        gc = plot.PlotGraphics(
                               [line], 'Speed Vs Engine RPM     Trip Distance: ' + '%.2f' % graph.Trip_Distance, 'Miles Per Hour', 'Engine RPM')
